...
export default function AvatarContact() {
  ...
  return (
    <div>
      <PhotoContainer>
        <ProfilePicture src="/images/prabhat.jpg" alt="profile" />
      </PhotoContainer>
      <ContactSection>
        ...
        <FlexRow onClick={handleClick}>
          <Button
            className={`${classes.f12} ${classes.button}`}
          ...
          >
            <Typography className={classes.addressPop}>
              46,Rajendra Nagar,
              <br /> Block 6 Sector 2, Sahibabad
            </Typography>
        ...
        <FlexRow>
          <PhoneAndroidIcon />
          <Typography className={classes.f12}>+91-7982223246</Typography>
        </FlexRow>
        ...
        <FlexRow className={classes.gitButton}>
          <Button type="button" className={`${classes.f12} ${classes.button}`}>
            ...
            <Typography style={{ marginLeft: "10px" }} className={classes.f12}>
              <AnchorLinks
                href="https://github.com/prabhatk850"
                target="_blank"
              >
                Github
              </AnchorLinks>
        ...
        <FlexRow>
          ...
          <Typography style={{ marginLeft: "10px" }} className={classes.f12}>
            <AnchorLinks
              href="https://linkedin.com/in/prabhatk850"
              target="_blank"
            >
              LinkedIn
            </AnchorLinks>
